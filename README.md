...
The ROC curves rise sharply toward the top-left corner with AUC consistently above 0.95. The model maintains strong sensitivity and specificity across various thresholds, and rarely confuses risky borrowers with low-risk ones.
